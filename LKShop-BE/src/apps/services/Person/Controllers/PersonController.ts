import { getListPerson, getPersonById, createPerson, updatePerson, deletePerson } from "../Repositories/PersonRepository";
...
export class PersonController {
    ...
    private async getListPersonHandler(req: Request, res: Response, next: NextFunction) {
        ...
        return res.status(200).send(new BaseResponse<Person[]>(persons, "Get Success", true))
    }
    ...
    private async getPersonByIdHandler(req: Request, res: Response) {
        ...
        return res.status(200).send(new BaseResponse<Person>(person, "Get Success", true))
    }
    ...
    private async createPersonHandler(req: Request, res: Response) {
        ...
        return res.status(200).send(new BaseResponse<Person>(person, "Create Success", true))
    }
