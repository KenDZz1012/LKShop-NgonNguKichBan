...
export class CategoryController {
    ...
    private async getListCategoryHandler(req: Request, res: Response, next: NextFunction) {
        ...
        return res.status(200).send(new BaseResponse<CategoryModel[]>(categories, "Get Success", true))
    }
    ...
    private async getCategoryByIdHandler(req: Request, res: Response) {
        ...
        return res.status(200).send(new BaseResponse<CategoryModel>(category, "Get Success", true))
    }
    ...
    private async createCategoryHandler(req: Request, res: Response) {
        ...
        return res.status(200).send(new BaseResponse<CategoryModel>(category, "Create Success", true))
    }
